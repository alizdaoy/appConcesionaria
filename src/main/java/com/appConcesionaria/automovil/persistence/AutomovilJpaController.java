...
import com.appConcesionaria.automovil.persistence.exceptions.NonexistentEntityException;
...
public class AutomovilJpaController implements Serializable {
    ...
    public AutomovilJpaController(){
        emf = Persistence.createEntityManagerFactory("persistenceAppConcesionaria");
    }
